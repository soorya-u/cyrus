...
function InputOTPSeparator({ ...props }: React.ComponentProps<"div">) {
	return (
		// biome-ignore lint/a11y/useFocusableInteractive: decorative OTP separator from shadcn
		// biome-ignore lint/a11y/useSemanticElements: decorative OTP separator from shadcn
		// biome-ignore lint/a11y/useAriaPropsForRole: decorative OTP separator from shadcn

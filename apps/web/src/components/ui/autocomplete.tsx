...
function AutocompleteItem({
	...
	return (
		<AutocompletePrimitive.Item
			className={cn(
				"flex min-h-8 cursor-default select-none items-center rounded-sm px-2 py-1 text-base outline-none hover:bg-accent data-disabled:pointer-events-none data-highlighted:bg-accent data-selected:bg-accent/50 data-highlighted:text-accent-foreground data-selected:text-foreground data-disabled:opacity-64 sm:min-h-7 sm:text-sm [&[data-highlighted][data-selected]]:bg-accent [&[data-highlighted][data-selected]]:text-accent-foreground [&_svg:not([class*='text-'])]:text-muted-foreground",
				className
			)}

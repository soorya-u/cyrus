/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 93e26ce6491304414a76dd3ac1735bfe)
...
interface __BaseEnv_Env {
	...
	ROOM: DurableObjectNamespace<import("./apps/server/src/index").Room>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DATABASE_URL" | "BETTER_AUTH_SECRET" | "BETTER_AUTH_URL" | "PORT" | "NODE_ENV" | "PRODUCTION_URL" | "OAUTH_GITHUB_CLIENT_ID" | "OAUTH_GITHUB_CLIENT_SECRET" | "OAUTH_PROXY_SECRET" | "ALLOWED_ORIGINS">> {}
}
